                    ...
                    <tbody>
                        ...
                        while ($row = $sql->fetch()) {
                            echo "<tr>
                                    ...
                                    <td>$row[level]</td>
                                    <td>
                                        <a href='' class='btn btn-sm btn-warning'><i class='bi-pencil-square'></i></a>
                                        <a href='' class='btn btn-sm btn-danger' onclick=\"return confirm('Hapus Data?')\"><i class='bi-trash'></i></a>
                                    </td>
                                </tr>";
